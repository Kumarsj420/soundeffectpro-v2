...
export default function Navbar() {
    ...
    const userLinks = [
        { id: 'your-profile', name: t('yourProfile'), href: '/user', icon: UserIcon },
        { id: 'your-uploads', name: t('yourUploads'), href: '/user/uploads', icon: ArrowUpOnSquareStackIcon },
        { id: 'your-likes', name: t('yourLikes'), href: '/user/likes', icon: HeartIcon },
        { id: 'your-soundboards', name: t('yourSoundboards'), href: '/user/soundboards', icon: CloudArrowUpIcon },
    ];

    const navLinks = [
        { id: 'recent-sound', title: t('recentSoundButton'), href: '/recent-buttons' },
        { id: 'most-downloaded', title: t('mostDownloadedButton'), href: '/popular' },
        { id: 'most-viewed', title: t('mostViewedButton'), href: '/most-viewed' },
        { id: 'most-liked', title: t('mostLikedButton'), href: '/most-liked' },
        { id: 'top-soundboards', title: t('topSoundboards'), href: '/soundboard' }
    ];


    const policyLinks = [
        { id: 'privacy-policy', title: t('privacyPolicy'), href: '/page/privacy-policy' },
        { id: 'terms-conditions', title: t('termsConditions'), href: '/page/terms-conditions' },
        { id: 'dmca-copyright', title: t('dmcaCopyright'), href: '/page/dmca-copyright' },
        { id: 'cookies-policy', title: t('cookiesPolicy'), href: '/page/cookie-policy' },
        { id: 'community-guidelines', title: t('communityGuidelines'), href: '/page/community-guidelines' },
        { id: 'contact-us', title: t('contactUs'), href: '/contact' }
    ];
    ...
    return (
        <>
            <header className="sticky top-0 z-50 bg-white border-gray-300 dark:bg-transparent dark:bg-linear-to-b dark:from-zinc-950/90 dark:via-zinc-900/90 dark:to-zinc-700/20 border-b dark:border-zinc-800 ">
                <div className="relative z-10 after:absolute after:inset-0 after:blur-2xl after:backdrop-blur-2xl after:-z-10">
                    <div className="py-3 px-5 sm:px-7 max-w-7xl 2xl:max-w-450 m-auto ">
                                            ...
                                            <div className="grid grid-cols-[1.5fr_1fr] gap-5 divide-x divide-gray-200 dark:divide-white/10">
                                                ...
                                                <div className="pr-5 divide-y divide-gray-200 dark:divide-white/10 space-y-3">
                                                    <div className="flex items-center gap-2 pb-3">
                                                        ...
                                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t('navTheme')}</h3>
                                                    </div>
                                                    <nav className="space-y-1">
                                                        ...
                                                        <div className="flex items-center justify-between px-4 py-2">
                                                            <Label htmlFor="setting-theme-nav">{t('darkMode')}</Label>
                                                ...
                                                <div className="divide-y divide-gray-200 dark:divide-white/10 space-y-3">
                                                    <div className="flex items-center gap-2 pb-3">
                                                        ...
                                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t('policies')}</h3>
                                                    </div>
                                                    <nav className="space-y-1">
                                                        {
