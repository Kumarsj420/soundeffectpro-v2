        ...
        <div className="min-h-screen text-gray-900 dark:text-zinc-100">
            <div>
                ...
                <section className="flex flex-col md:flex-row gap-6 items-start ">
                    {/* Thumbnail */}
                    <div className="aspect-square w-48 h-36 bg-white dark:bg-zinc-900 rounded-xl shadow-lg shadow-gray-300 dark:shadow-zinc-900 flex items-center justify-center shrink-0 relative overflow-hidden">
                        {boardData.thumb ? (
                            <Image
                                src={getR2Url(`thumb/${boardData.thumb}`) ?? ''}
                                alt={boardData.name}
                                width={160}
                                height={160}
