  ...
  return (
    <Dialog open={open} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 z-10 flex items-center justify-center p-3">
        <DialogPanel
          transition
          className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-linear-to-b from-zinc-800 to-zinc-900 py-4 px-6 shadow-2xl transition-all data-closed:scale-95 data-closed:opacity-0 sm:py-7 sm:px-7 z-10 after:absolute after:-z-10 after:inset-0.5 after:bg-zinc-900 after:rounded-[inherit]"
        >
          <button
            onClick={onClose}
